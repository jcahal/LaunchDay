...
****************************************************
//LIBRARIES
  //Up to date libraries folder can be downloaded at: 
  // https://github.com/PC-Ascend-Team/libraries)
  ...
  #include <Adafruit_LSM303_U.h>    //IMU - Compass (Accel + Magneto)
  #include <Adafruit_L3GD20_U.h>    //IMU - Gyroscope
...
//DEFINITIONS
 ...
 // Adafruit_L3GD20_Unified    G = Adafruit_L3GD20_Unified(????);       //Not used in the AHRS orientation calculations
 ...
 int MQ-4 = A1;   // LPG Sensor
 int MQ-6 = A2;   // Methane Sensor
 int MQ-7 = A3;   // Carbon Monoxide Sensor
 ...
 */
   ...
   //Phoenix College Acsend Team SETUP (LED signals)
   //////////////////////////////////////////////////////
   //pinModes
  /* pinMode(LD0, OUTPUT);
   ...
   Serial.println(F("LPG,CH4,CO,roll,pitch,yaw,IMUP,IMUT,H:M:S.ms,DD/MM/20YY,Fix,FixQ,Lat,Long,LatD,LongD,Speed,Angle,GAlt,Sats"));
   delay(1000);
 ...
 */
 //      digitalWrite(LD0, HIGH); //Light LD0 to indicate start data loging
       ...
       //GAS SENSORS OPERATIONS
       //////////////////////////////////////////////////////
       //Get a new gas sensor reading
       MQ-4_Value = averageAnalogRead(1);        // read LPG analog input pin 1
       MQ-6_Value = averageAnalogRead(2);        // read CH4 analog input pin 2
       MQ-7_Value = averageAnalogRead(3);       // read CO analog input pin 3
       ...
       */
       ...
       //Display IMU BMP Sensor Information: Pressure, Temp, Alt
       B.getEvent(&B_event);
       if (B_event.pressure){
       ...
       //////////////////////////////////////////////////////
       int mq4Level = averageAnalogRead(MQ-4);
       int mq6Level = averageAnalogRead(MQ-6);
       int mq7Level = averageAnalogRead(MQ-7);

       float mq4Intensity = mapfloat(mq4Level, , , ,);    //Convert the voltage to PPM
       float mq6Intensity = mapfloat(mq6Level, , , ,);    //Convert the voltage to PPM
       float mq7Intensity = mapfloat(mq7Level, , , ,);    //Convert the voltage to PPM

       Serial.print(mq4Level, DEC);           Serial.print(F(","));
       Serial.print(mq6Level, DEC);           Serial.print(F(","));
       Serial.print(mq7Level, DEC);           Serial.print(F(","));

       Serial.print(mq4Intensity, DEC);       Serial.print(F(","));
       Serial.print(mq6Intensity, DEC);       Serial.print(F(","));
       Serial.print(mq7Intensity, DEC);       Serial.print(F(","));
